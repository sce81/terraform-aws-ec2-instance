...
| Name | Description |
| ---- | ----------- |
| <a name="output_instance_id"></a> [instance\_id](#output\_instance\_id) | output "private\_eni" { value = aws\_network\_interface.main.id }  output "private\_ip" { value = aws\_network\_interface.main.private\_ips } |
<!-- END_TF_DOCS -->
